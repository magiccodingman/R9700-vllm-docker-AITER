...
AMD's wheel reports an internal HIP build such as `7.13.99004`, so the validator checks the exact ROCm package version and the HIP `7.13` release family rather than requiring that internal build string to equal `7.13.0` literally.
